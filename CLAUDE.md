...
### From docs/optimize_please.md

11. ✅ Zero per-line allocations in parser - Borrows shard &str, uses scalar coords
12. ✅ Parallel file parsing - `into_par_iter()` in ingest_bed_files
13. ✅ Parallel shard processing - `par_iter()` in flush_intervals_to_disk
14. ✅ Eliminated running_counts - tile_size > max_interval ensures no interval spans a tile
